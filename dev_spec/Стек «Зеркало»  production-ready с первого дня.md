...
**Синхронизация с POD:** актуальная каноническая спецификация — `Mirror_POD_v2.md` **v2.2** (§12 — NATS JetStream, Keycloak, Haystack, Temporal, стратегии Qdrant A/B, доменный Memory API). Этот документ — практическое дополнение к §12.4–§12.8.
