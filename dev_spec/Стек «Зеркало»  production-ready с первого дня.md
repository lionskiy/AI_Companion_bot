...
**Синхронизация с POD:** каноническая спецификация — `Mirror_POD_v2.md` **v2.5**; карта требований к разделам — **§1.2** POD; стек и операционные детали — §12–§14 POD. Этот документ — практическое дополнение к §12.4–§12.8 POD.
